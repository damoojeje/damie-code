...
```bash
git clone https://github.com/damoojeje/damie-code.git # Or your fork's URL
cd gemini-cli
```
...
- Consult [DAMIE.md](https://github.com/damoojeje/damie-code/blob/main/DAMIE.md) (typically found in the project root) for specific instructions related to AI-assisted development, including conventions for React, comments, and Git usage.
