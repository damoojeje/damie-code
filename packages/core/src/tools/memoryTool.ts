  ...
  parametersJsonSchema: {
    ...
    properties: {
      ...
      scope: {
        type: 'string',
        description:
          'Where to save the memory: "global" saves to user-level ~/.damie/DAMIE.md (shared across all projects), "project" saves to current project\'s DAMIE.md (project-specific). If not specified, will prompt user to choose.',
        enum: ['global', 'project'],
      },
    },
    required: ['fact'],
...
- \`scope\` (string, optional): Where to save the memory:
  - "global": Saves to user-level ~/.damie/DAMIE.md (shared across all projects)
  - "project": Saves to current project's DAMIE.md (project-specific)
  - If not specified, the tool will ask the user where they want to save the memory.
`;

export const QWEN_CONFIG_DIR = '.damie';
export const DEFAULT_CONTEXT_FILENAME = 'DAMIE.md';
export const MEMORY_SECTION_HEADER = '## Damie Added Memories';

// This variable will hold the currently configured filename for DAMIE.md context files.
