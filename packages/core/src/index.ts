...
export * from './config/damieConfig.js';
export * from './config/damieConfigLoader.js';
...
// Export Skills System (Phase 11)
export * from './skills/index.js';

// Export Profiles System (Phase 12)
export * from './profiles/index.js';

// Export Plugin System (Phase 13)
export * from './plugins/index.js';

// Export Sysadmin Tools (Phase 14)
export * from './sysadmin/index.js';

// Export Package Manager (Phase 15)
