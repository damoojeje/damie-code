...
export function getCoreSystemPrompt(
  ...
  const basePrompt = systemMdEnabled
    ...
    : `
You are Damie Code, an AI-powered CLI coding assistant, specializing in software engineering tasks. Your primary goal is to help users safely and efficiently, adhering strictly to the following instructions and utilizing your available tools.
