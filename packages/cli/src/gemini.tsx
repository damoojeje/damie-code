...
import { isFirstRun, runSetupWizard, shouldSkipSetup } from './setup/index.js';
...
export async function main() {
  ...
  // may have side effects.
  {
    ...
    if (!input) {
      console.error(
        `No input provided via stdin. Input can be provided by piping data into damie or using the --prompt option.`,
      );
      process.exit(1);
    }
