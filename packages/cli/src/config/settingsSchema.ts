  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Damie Code status and thoughts in the terminal window title',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (DAMIE.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
    ...
    properties: {
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectQwenIgnore: {
            type: 'boolean',
            label: 'Respect .damieignore',
            category: 'Context',
            requiresRestart: true,
            default: true,
            description: 'Respect .damieignore files when searching',
            showInDialog: true,
          },
          ...
          deepseek: {
            ...
            properties: {
              ...
              model: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 'deepseek-chat' as string | undefined,
              ...
              timeout: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 30000 as number | undefined,
                description: 'Request timeout in milliseconds.',
                showInDialog: true,
              },
            },
          ...
          anthropic: {
            ...
            properties: {
              ...
              model: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 'claude-3-5-sonnet-20241022' as string | undefined,
              ...
              timeout: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 60000 as number | undefined,
                description: 'Request timeout in milliseconds.',
                showInDialog: true,
              },
            },
          ...
          openrouter: {
            ...
            properties: {
              ...
              baseUrl: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 'https://openrouter.ai/api/v1' as string | undefined,
          ...
          ollama: {
            ...
            properties: {
              baseUrl: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 'http://localhost:11434' as string | undefined,
              ...
              model: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 'llama3.1' as string | undefined,
          ...
          openai: {
            ...
            properties: {
              ...
              model: {
                ...
                category: 'Security',
                requiresRestart: true,
                default: 'gpt-4' as string | undefined,
