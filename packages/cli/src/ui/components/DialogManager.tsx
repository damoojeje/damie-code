...
import { PluginsDialog } from './PluginsDialog.js';
...
import { getPluginService } from '../../services/pluginService.js';
  ...
  if (uiState.isSkillsDialogOpen) {
    return (
      <SkillsDialog
        ...
        onExit={uiActions.closeSkillsDialog}
      />
    );
  }

  if (uiState.isPluginsDialogOpen) {
    return (
      <PluginsDialog
        pluginService={getPluginService()}
        onExit={uiActions.closePluginsDialog}
      />
    );
  }

  if (uiState.isProfileSelectorOpen) {
    return (
      <ProfileSelector
        profileService={getProfileService()}
        onExit={uiActions.closeProfileSelector}
      />
    );
  }
