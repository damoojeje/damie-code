...
import { ApprovalMode } from '@damie-code/damie-code-core';
...
// Platform-aware arrow characters for Windows compatibility
// Note: Ink rendering uses Unicode characters regardless of platform
const LEFT_ARROW = '←';
const RIGHT_ARROW = '→';
