...
vi.mock('@damie-code/damie-code-core', async () => {
  const actual = await vi.importActual('@damie-code/damie-code-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import type { GeminiClient } from '@damie-code/damie-code-core';
import { uiTelemetryService } from '@damie-code/damie-code-core';
