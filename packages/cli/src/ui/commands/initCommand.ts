...
import { getCurrentGeminiMdFilename } from '@damie-code/damie-code-core';
...
export const initCommand: SlashCommand = {
  name: 'init',
  description: 'Analyzes the project and creates a tailored DAMIE.md file.',
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are Damie Code, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
