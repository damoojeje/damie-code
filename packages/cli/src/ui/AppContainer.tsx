...
import { usePluginsDialog } from './hooks/usePluginsDialog.js';
import { useProfileSelector } from './hooks/useProfileSelector.js';
    ...
    historyManager.addItem(
      {
        ...
        text: 'Refreshing hierarchical memory (DAMIE.md or other context files)...',
      },
      Date.now(),
    );
    try {
