...
import type { Config } from '@damie-code/damie-code-core';
import { OutputFormat, FatalInputError } from '@damie-code/damie-code-core';
import {
  getErrorMessage,
  handleError,
  handleToolError,
...
vi.mock('@damie-code/damie-code-core', async (importOriginal) => {
  const original =
    await importOriginal<typeof import('@damie-code/damie-code-core')>();
